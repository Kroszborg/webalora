        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            <Button
              asChild
              size="lg"
              className="bg-white/10 backdrop-blur-md text-white border border-white/50 hover:bg-white/20 transition-all duration-300 shadow-[0_4px_10px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.2)]"
            >

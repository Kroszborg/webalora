      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <form
            ...
            className="space-y-6 bg-white/50 backdrop-blur-md p-8 rounded-xl neumorphism-shadow"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <Input
                  ...
                  required
                  className="w-full bg-white/50 backdrop-blur-sm border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-lg neumorphism-shadow"
                />
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.02 }}
              ...
              <motion.div whileHover={{ scale: 1.02 }} className="col-span-2">
                ...
                >
                  <SelectTrigger className="w-full bg-white/50 backdrop-blur-sm border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-lg neumorphism-shadow">
